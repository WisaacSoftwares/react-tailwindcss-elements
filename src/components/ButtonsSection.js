...
const ButtonsSection = ({ darkTheme }) => {
  ...
  return (
    // <div className="bg-slate-800 border text-white border-gray-200 rounded-xl shadow-sm overflow-hidden">
    <div className={mixClasses([darkTheme ? "bg-slate-800 text-white" : "bg-white", "border border-gray-200 rounded-xl shadow-sm overflow-hidden"])}>
